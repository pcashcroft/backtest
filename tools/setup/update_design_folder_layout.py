...
How to run:
C:/Users/pcash/anaconda3/envs/backtest/python.exe tools/setup/update_design_folder_layout.py
...
def main() -> int:
    ...
    parts.append("It is auto-generated by `tools/setup/update_design_folder_layout.py`.")
    parts.append("")
